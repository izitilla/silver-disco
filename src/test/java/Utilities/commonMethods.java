...
import com.github.javafaker.service.RandomService;
 ...
 public class commonMethods extends PageInitializer{
	// everytime whenever you use method or anything, any action, block of code more
			// than once, you will turned into
			// function
			...
			// overloading the same method with the different signature. (in the same class)
			//ovberriding is 2 different class you can overridingn another method with its own 
			//inplementation 
			public static void sendKey(WebElement element, int text) {
		...
		//		element.sendKeys(text);
			...
			public static void switchToIFrameElement(WebElement iframeElement) {
				// homework
				try {
			...
			// child
			// the user should have already oepened or clicked a link where a new tab/window
			// openend
			...
			public static void scrollToElements(List<WebElement> element) {
			...
			public static void clickByJS(WebElement element) {
			   ...
			   public static void clearAndType(WebElement element, String text) {
			        element.clear(); // Clear the current value
			        element.sendKeys(text); // Type the new value
			    }
